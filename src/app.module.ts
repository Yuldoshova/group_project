...
import { RedisCustomModule } from 'src/client';
import { appConfig, dbConfig, emailConfig, jwtConfig } from 'src/config';
import { CheckAuthGuard, CheckRoleGuard } from 'src/guards';
import { AuthModule, Color, ColorModule, UploadModule, User, UserModule } from 'src/modules';
